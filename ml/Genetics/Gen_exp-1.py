...
popN = 105 # n number of chromos per population
genesPerCh = 75
max_iterations = 1000
target = 200.0  # The target number for which we want the expression 
crossover_rate = 0.7
mutation_rate = 0.05
...
def roulette (fitnessScores):	#fitnessScores:list of nos
...
def main(): 
  ...
  while iterations != max_iterations and solution_found == False:	#!= True:
